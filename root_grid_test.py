...
class StartPage(tkinter.Frame):
    def __init__(self, master):
        ...
        self.label.config(fg='black', font="Arial 12")
        ...
        self.example_text.config(font="Purisa 18", background='blue', fg='white')
        self.example_text.grid(column=0, row=3, padx=10, pady=10)

        self.example_question = tkinter.Label(self)
        self.example_question.config(font="Purisa 18", background='red', fg='white')
        ...
        self.entry = tkinter.Entry(frame_top, font="Arial 12", fg='black')
        ...
        self.check_button = tkinter.Button(frame_top, text="Проверить", font="Arial 12")
        self.check_button.config(command=self.change)
        self.check_button.grid(column=3, row=0, padx=10, pady=10)
...
class PageOne(tkinter.Frame):
    def __init__(self, master):
        ...
        last_ten_words_frame = tkinter.Label(self, background='red', text='Last 10 words added',
                                                  fg='#993333', font="Arial 14")
        last_ten_words_frame.grid(column=0, row=0, padx=10, pady=10)
